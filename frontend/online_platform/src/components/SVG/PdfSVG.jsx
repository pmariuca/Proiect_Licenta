function PdfSVG() {
    return (
        <svg viewBox="0 0 32 32" width="30px" height="30px" fill="#000000">
            <g strokeWidth="0"></g>
            <g strokeLinecap="round" strokeLinejoin="round"></g>
            <g>
                <path d="M24.1,2.072h0l5.564,5.8V29.928H8.879V30H29.735V7.945L24.1,2.072" style={{ fill: "#909090"}}></path>
                <path d="M24.031,2H8.808V29.928H29.664V7.873L24.03,2" style={{ fill: "#f4f4f4"}}></path>
                <path d="M8.655,3.5H2.265v6.827h20.1V3.5H8.655" style={{ fill: "#7a7b7c"}}></path>
                <path d="M22.472,10.211H2.395V3.379H22.472v6.832" style={{ fill: "#dd2025"}}></path>
                <path
                ...
                <path
                    ...
                    style={{ fill: "#464648"}}></path>
                <path d="M17.43,4.538H15v4.8h1.028V7.434h1.3V6.542h-1.3V5.43h1.4V4.538" style={{ fill: "#464648"}}></path>
                <path
                    ...
                    style={{ fill: "#dd2025"}}></path>
                <path d="M23.954,2.077V7.95h5.633L23.954,2.077Z" style={{ fill: "#909090"}}></path>
                <path d="M24.031,2V7.873h5.633L24.031,2Z" style={{ fill: "#f4f4f4"}}></path>
                <path
                ...
                <path
                    ...
                    style={{ fill: "#fff"}}></path>
                <path d="M17.353,4.461h-2.43v4.8h1.028V7.357h1.3V6.465h-1.3V5.353h1.4V4.461" style={{ fill: "#fff"}}></path>
            </g>
        </svg>
    )
}
